...
public class TileMenuTiles : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        toptabs.AddRange(new List<int> { -1, 139, 119, 135, 125, 122, 123, 128, 342, 6, -2 });
        toptabs.AddRange(new List<int> { -1, 222, 255, 445, 456, 6, 6, 6, 6, 6, -2 });
        //and then do the rest of the tiles 80 at a time:
        toptabs.AddRange(new List<int> { -1, 6, 6, 6, 477, 481, 561, 641, 721, 801, -2 }); 

        //TODO: make this a json
        BottomTiles.Add(new List<int>());//-1
        BottomTiles.Add(new List<int> { 1, 2, 3, 4, 7, 8, 9, 10, 11, 12, 23, 24, 26, 27, 28, 29, 30, 31, 33, 34, 35, 36, 37, 38, 47, 48, 49, 50, 69, 71, 72, 73, 74, 75, 78, 79, 80, 81, 82, 83, 101, 102, 103, 104, 105, 106, 109, 110, 111, 112, 331, 332, 335, 333, 334, 336, 311, 312, 314, 318, 326, 316, 325, 317, 319, 324, 320, 321 });//10 house parts
        BottomTiles.Add(new List<int> { 13, 42, 43, 44, 45, 46, 65, 66, 113, 213, 214, 242, 243, 306, 307, 308, 309, 310, 329, 330, 347 });//13 water
        BottomTiles.Add(new List<int> { 16, 17, 18, 56, 57, 58, 59, 63, 64, 76, 77, 84, 296, 297, 298, 299, 301, 303, 304, 327, 328 });//18 cliffs
        BottomTiles.Add(new List<int> { 20, 39, 40, 67, 87, 88, 91, 93, 95, 96 });//20 ledges
        BottomTiles.Add(new List<int> { 32, 366, 70, 305});//32 trees
        BottomTiles.Add(new List<int> { 14, 22, 41, 244, 217, 218 });//14 man made obsticles
        BottomTiles.Add(new List<int> { 6, 294, 315, 300, 5, 21, 116, 114, 115, 338, 302, 363, 362, 361, 19, 107, 108, 25, 337 });//25 natural ground cover in sparse to full order
        BottomTiles.Add(new List<int> { 15, 51, 52, 53, 54, 55, 60, 61, 62, 68, 85, 86, 89, 90, 92, 94, 97, 98, 99, 100, 212, 215, 216});//15 unnatural ground cover
        BottomTiles.Add(new List<int> { 295, 343 });//343 rocks
        BottomTiles.Add(new List<int>());//-2
        BottomTiles.Add(new List<int>());//-1
        BottomTiles.Add(new List<int> { 139, 140, 189, 190, 170, 171, 407, 408 });//139 indoor plants
        BottomTiles.Add(new List<int> { 118, 119, 120, 121, 133, 134, 136, 138, 141, 142, 149, 150, 155, 157, 169, 197, 198, 199, 200, 211, 260, 261, 263, 264, 241, 382, 383, 385, 387, 386, 197, 262, 265, 266, 364, 365, 432, 439, 433, 438, 274, 199, 199, 277, 465, 420, 435, 436, 434, 419, 275, 276, 278, 279, 418, 398, 395, 396, 424, 425, 426, 428, 397 });//119 tables
        BottomTiles.Add(new List<int> { 127, 130, 135, 137, 152, 182, 183, 184, 185, 421, 245, 246, 423, 422, 391, 392, 393, 394, 380, 381, 410 });//135 TV Typewriters http://catb.org/~esr/jargon/html/tv-typewriters.html
        BottomTiles.Add(new List<int> { 124, 125, 143, 144, 146, 147, 188, 204, 205, 208, 209, 353, 437, 403, 404, 412, 413, 414, 415, 416, 417 });//125 bookcases
        BottomTiles.Add(new List<int> { 122, 126, 131, 181, 145, 151, 153, 154, 156, 167, 174, 194, 195, 196, 186, 187, 202, 203, 192, 175, 177, 178, 180, 193, 210, 201, 206, 267, 268, 271, 272, 280, 281, 282, 283, 284, 286, 269, 270, 273, 287, 288, 289, 290, 291, 292, 348, 355, 349, 350, 357, 353, 354, 356, 358, 359, 339, 370, 371, 372, 373, 374, 375, 376, 377, 384, 401, 389, 406, 440, 453, 468 });//122 walls
        BottomTiles.Add(new List<int> { 117, 123, 132, 148, 158, 159, 160, 161, 162, 163, 164, 165, 166, 168, 173, 176, 179, 207, 257, 258, 259, 293, 340, 346, 360, 367, 368, 369, 378, 379, 399, 400, 411, 390, 345, 427, 429, 430, 475, 341, 401, 402, 452, 352, 467, 6, 6, 431, 476, 405 });//123 floor
        BottomTiles.Add(new List<int> { 128, 129, 172, 191, 285, 388 });//128 stairs
        BottomTiles.Add(new List<int> { 322, 342, 441, 443, 313, 6, 6, 6, 6, 6, 323, 344, 442 });//342 statues
        ...
        BottomTiles.Add(new List<int> { 131, 247, 248, 251, 122, 122, 247, 248, 251, 131, 131, 249, 250, 252, 253, 253, 249, 250, 252, 131, 131, 254, 255, 256, 257, 257, 254, 255, 256, 131 });//255 teleporter
        BottomTiles.Add(new List<int> { 448, 445, 444, 446, 450, 6, 6, 6, 6, 6, 449, 444, 445, 447, 451 });//445 window
        BottomTiles.Add(new List<int> { 459, 461, 462, 469, 454, 455, 456, 6, 6, 6, 460, 463, 464, 470, 457, 458, 466, 6, 6, 6, 471, 472, 473, 474, 6, 6, 6, 6, 6, 6, 460, 463, 464, 470 });//456 museum pieces
        BottomTiles.Add(new List<int> { });//6
        BottomTiles.Add(new List<int> { });//6
        BottomTiles.Add(new List<int> { });//6
        BottomTiles.Add(new List<int> { });//6
        ...
        BottomTiles.Add(new List<int> { });//6
        BottomTiles.Add(new List<int> { });//6
        BottomTiles.Add(new List<int> { 477, 478, 479, 480 });//477
