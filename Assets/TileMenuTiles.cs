...
public class TileMenuTiles : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        toptabs.AddRange(new List<int> { -1, 6, 6, 212, 241, 321, 401, 481, 561, 641, -2 }); 
        ...
        BottomTiles.Add(new List<int> { 118, 119, 120, 121, 133, 134, 136, 138, 141, 142, 149, 150, 155, 157, 169, 197, 198, 199, 200, 211 });//119 tables
        BottomTiles.Add(new List<int> { 127, 130, 135, 137, 152, 182, 183, 184, 185 });//135 TV Typewriters http://catb.org/~esr/jargon/html/tv-typewriters.html
        BottomTiles.Add(new List<int> { 124, 125, 143, 144, 146, 147, 188, 204, 205, 208, 209 });//125 bookcases
        BottomTiles.Add(new List<int> { 122, 126, 131, 181, 145, 151, 153, 154, 156, 167, 174, 194, 195, 196, 186, 187, 202, 203, 192, 175, 177, 178, 180, 193, 210, 201, 206 });//122 walls
        BottomTiles.Add(new List<int> { 117, 123, 132, 148, 158, 159, 160, 161, 162, 163, 164, 165, 166, 168, 173, 176, 179, 207 });//123 floor
        BottomTiles.Add(new List<int> { 128, 129, 172, 191 });//128 stair
        BottomTiles.Add(new List<int> { });//6
        BottomTiles.Add(new List<int> { });//6
        BottomTiles.Add(new List<int>());//-2
        BottomTiles.Add(new List<int>());//-1
        BottomTiles.Add(new List<int> { });//6
        BottomTiles.Add(new List<int> { });//6
        BottomTiles.Add(new List<int> { 212, 213, 214, 215, 216, 217, 218, 219, 220, 221, 222, 223, 224, 225, 226, 227, 228, 229, 230, 231, 232, 233, 234, 235, 236, 237, 238, 239, 240 });//212
