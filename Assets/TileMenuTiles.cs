...
public class TileMenuTiles : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        toptabs.AddRange(new List<int> { -1, 139, 119, 135, 125, 122, 123, 128, 6, 6, -2 });
        toptabs.AddRange(new List<int> { -1, 222, 255, 6, 6, 6, 6, 6, 6, 6, -2 });
        //and then do the rest of the tiles 80 at a time:
        toptabs.AddRange(new List<int> { -1, 6, 294, 321, 401, 481, 561, 641, 721, 801, -2 }); 
        ...
        BottomTiles.Add(new List<int> { 13, 42, 43, 44, 45, 46, 65, 66, 113, 213, 214, 242, 243 });//13 water
        ...
        BottomTiles.Add(new List<int>());//-1
        BottomTiles.Add(new List<int> { 139, 140, 189, 190, 170, 171 });//139 plants
        BottomTiles.Add(new List<int> { 118, 119, 120, 121, 133, 134, 136, 138, 141, 142, 149, 150, 155, 157, 169, 197, 198, 199, 200, 211, 260, 261, 263, 264, 241, 6, 6, 6, 6, 6, 197, 262, 265, 266, 6, 6, 6, 6, 6, 6, 274, 199, 199, 277, 6, 6, 6, 6, 6, 6, 275, 276, 278, 279 });//119 tables
        BottomTiles.Add(new List<int> { 127, 130, 135, 137, 152, 182, 183, 184, 185, 245, 246 });//135 TV Typewriters http://catb.org/~esr/jargon/html/tv-typewriters.html
        BottomTiles.Add(new List<int> { 124, 125, 143, 144, 146, 147, 188, 204, 205, 208, 209 });//125 bookcases
        BottomTiles.Add(new List<int> { 122, 126, 131, 181, 145, 151, 153, 154, 156, 167, 174, 194, 195, 196, 186, 187, 202, 203, 192, 175, 177, 178, 180, 193, 210, 201, 206, 267, 268, 271, 272, 280, 281, 282, 283, 284, 286, 269, 270, 273, 287, 288, 289, 290, 291, 292 });//122 walls
        BottomTiles.Add(new List<int> { 117, 123, 132, 148, 158, 159, 160, 161, 162, 163, 164, 165, 166, 168, 173, 176, 179, 207, 257, 258, 259, 293 });//123 floor
        BottomTiles.Add(new List<int> { 128, 129, 172, 191, 285 });//128 stair
        BottomTiles.Add(new List<int> { });//6
        BottomTiles.Add(new List<int> { });//6
        BottomTiles.Add(new List<int>());//-2
        BottomTiles.Add(new List<int>());//-1
        ...
        BottomTiles.Add(new List<int>());//-1
        BottomTiles.Add(new List<int> { });//6
        BottomTiles.Add(new List<int> { 294, 295, 296, 297, 298, 299, 300, 301, 302, 303, 304, 305, 306, 307, 308, 309, 310, 311, 312, 313, 314, 315, 316, 317, 318, 319, 320 });//294
