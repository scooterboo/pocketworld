...
public class TileMenuTiles : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        toptabs.AddRange(new List<int> { -1, 6, 6, 6, 6, 6, 6, 6, 6, 780, -2 }); 
        ...
        BottomTiles.Add(new List<int> { 127, 130, 135, 137, 152, 182, 183, 184, 185, 421, 245, 246, 423, 422, 391, 392, 393, 394, 380, 381, 410, 586, 587, 588, 589, 592, 624, 625, 630, 722, 723 });//135 TV Typewriters http://catb.org/~esr/jargon/html/tv-typewriters.html
        ...
        BottomTiles.Add(new List<int> { });//6
        BottomTiles.Add(new List<int> { });//6
        BottomTiles.Add(new List<int> { 780, 781, 782, 783, 784, 785, 786, 787, 788, 789, 790, 791, 792, 793, 794, 795, 796, 797, 798, 799, 800, 801, 802, 803, 804, 805, 806, 807, 808, 809, 810, 811, 812, 813, 814, 815, 816, 817, 818, 819, 820, 821, 822, 823, 824, 825, 826 });//780
