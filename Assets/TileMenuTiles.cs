...
public class TileMenuTiles : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        toptabs.AddRange(new List<int> { -1, 132, 222, 255, 445, 456, 274, 6, 6, 6, -2 });
        //and then do the rest of the tiles 80 at a time:
        toptabs.AddRange(new List<int> { -1, 6, 6, 6, 6, 6, 6, 717, 721, 801, -2 }); 
        ...
        BottomTiles.Add(new List<int> { 124, 125, 143, 144, 146, 147, 188, 204, 205, 208, 209, 351, 437, 403, 404, 412, 413, 414, 415, 416, 417, 568, 632, 633, 634, 635, 640, 644, 660, 700, 702 });//125 bookcases
        ...
        BottomTiles.Add(new List<int> { 117, 123, 158, 159, 160, 161, 162, 163, 164, 165, 166, 168, 173, 176, 179, 207, 257, 259, 293, 340, 346, 360, 367, 368, 369, 378, 379, 411, 390, 345, 452, 352, 467, 427, 539, 555, 578, 581, 582, 583, 590, 593, 612, 613, 619, 620, 621, 628, 631, 646, 669, 672, 676, 679, 682, 683, 684, 685, 686, 701, 703, 704 });//123 floor
        ...
        BottomTiles.Add(new List<int>());//-2
        BottomTiles.Add(new List<int>());//-1
        BottomTiles.Add(new List<int> { 132, 148 , 258, 540, 429, 430, 475, 341, 541, 543, 544, 476, 405, 431, 561 });//132 rugs
        ...
        BottomTiles.Add(new List<int> { });//6
        BottomTiles.Add(new List<int> { });//6
        BottomTiles.Add(new List<int> { 717, 718, 719, 720 });//717
