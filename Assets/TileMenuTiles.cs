...
public class TileMenuTiles : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        toptabs.AddRange(new List<int> { -1, 10, 20, 30, 40, 50, 60, 70, 80, 90, -2 }); //top tab set 1
        //and then do the rest of the tiles 80 at a time:
        toptabs.AddRange(new List<int> { -1, 1, 81, 161, 241, 321, 401, 481, 561, 641, -2 }); //top tab set 2
        toptabs.AddRange(new List<int> { -1, 721, 801, 6, 6, 6, 6, 6, 6, 6, -2 }); //top tab set 3

        //TODO: make this a json
        BottomTiles.Add(new List<int>());//-1
        BottomTiles.Add(new List<int> { 1, 2, 3, 4, 5, 6 });//10
        BottomTiles.Add(new List<int>());//20
        BottomTiles.Add(new List<int>());//30
        BottomTiles.Add(new List<int>());//40
        BottomTiles.Add(new List<int>());//50
        BottomTiles.Add(new List<int>());//60
        BottomTiles.Add(new List<int>());//70
        BottomTiles.Add(new List<int>());//80
        BottomTiles.Add(new List<int>());//90
