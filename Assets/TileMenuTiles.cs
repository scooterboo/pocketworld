...
public class TileMenuTiles : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        BottomTiles.Add(new List<int> { 118, 119, 120, 121, 133, 134, 564, 136, 138, 141, 142, 149, 150, 155, 157, 197, 198, 199, 200, 211, 241, 382, 383, 385, 387, 386, 364, 365, 432, 439, 433, 438, 465, 420, 435, 436, 434, 419, 418, 398, 395, 396, 424, 425, 426, 428, 397, 547, 548, 550, 551, 552, 554, 201, 206, 557, 558, 559, 560, 169, 570, 580, 626, 627, 629, 638, 639, 641, 642, 643, 647, 648, 649, 650, 653, 654, 656, 670, 671 });//119 tables
        ...
        BottomTiles.Add(new List<int> { 186, 187, 192, 175, 177, 178, 180, 193, 210, 281, 282, 283, 286, 288, 289, 290, 291, 292, 353, 354, 356, 358, 359, 370, 371, 372, 373, 374, 375, 376, 377, 562, 563, 571, 572, 549, 584 });//193 partitions
        BottomTiles.Add(new List<int>());//-2
        BottomTiles.Add(new List<int>());//-1
