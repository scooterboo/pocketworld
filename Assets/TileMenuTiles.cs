...
public class TileMenuTiles : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        BottomTiles.Add(new List<int> { 118, 119, 120, 121, 133, 134, 564, 136, 138, 141, 142, 149, 150, 155, 157, 197, 198, 199, 200, 211, 241, 382, 383, 385, 387, 386, 364, 365, 432, 439, 433, 438, 465, 420, 435, 436, 434, 419, 418, 398, 395, 396, 424, 425, 426, 428, 397, 547, 548, 550, 551, 552, 554, 201, 206, 557, 558, 559, 560, 169, 570, 580 });//119 tables
        BottomTiles.Add(new List<int> { 127, 130, 135, 137, 152, 182, 183, 184, 185, 421, 245, 246, 423, 422, 391, 392, 393, 394, 380, 381, 410, 586, 587, 588, 589, 592 });//135 TV Typewriters http://catb.org/~esr/jargon/html/tv-typewriters.html
        BottomTiles.Add(new List<int> { 124, 125, 143, 144, 146, 147, 188, 204, 205, 208, 209, 351, 437, 403, 404, 412, 413, 414, 415, 416, 417, 568 });//125 bookcases
        BottomTiles.Add(new List<int> { 122, 126, 131, 181, 145, 151, 153, 154, 156, 167, 174, 194, 195, 196, 186, 187, 202, 203, 192, 175, 177, 178, 180, 193, 210, 453, 468, 272, 280, 281, 282, 283, 284, 286, 287, 288, 289, 290, 291, 292, 348, 355, 349, 350, 357, 353, 354, 356, 358, 359, 339, 370, 371, 372, 373, 374, 375, 376, 377, 384, 409, 389, 406, 440, 553, 562, 563, 566, 569, 571, 572, 549, 584, 585 });//122 walls
