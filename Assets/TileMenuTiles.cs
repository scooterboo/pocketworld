...
public class TileMenuTiles : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        toptabs.AddRange(new List<int> { -1, 6, 6, 6, 6, 6, 622, 641, 721, 801, -2 }); 
        ...
        BottomTiles.Add(new List<int> { 118, 119, 120, 121, 133, 134, 564, 136, 138, 141, 142, 149, 150, 155, 157, 197, 198, 199, 200, 211, 241, 382, 383, 385, 387, 386, 364, 365, 432, 439, 433, 438, 465, 420, 435, 436, 434, 419, 418, 398, 395, 396, 424, 425, 426, 428, 397, 547, 548, 550, 551, 552, 554, 201, 206, 557, 558, 559, 560, 169, 570, 580, 626, 627, 629, 638, 639, 641, 642, 643, 647, 648, 649, 650 });//119 tables
        ...
        BottomTiles.Add(new List<int> { 124, 125, 143, 144, 146, 147, 188, 204, 205, 208, 209, 351, 437, 403, 404, 412, 413, 414, 415, 416, 417, 568, 632, 633, 634, 635, 640, 644 });//125 bookcases
        BottomTiles.Add(new List<int> { 122, 126, 131, 181, 145, 151, 153, 154, 156, 167, 174, 194, 195, 196, 202, 203, 453, 468, 272, 280, 284, 287, 348, 355, 349, 350, 357, 339, 384, 409, 389, 406, 440, 553, 566, 569, 585, 622, 623, 636, 637, 645 });//122 walls
        BottomTiles.Add(new List<int> { 117, 123, 132, 148, 158, 159, 160, 161, 162, 163, 164, 165, 166, 168, 173, 176, 179, 207, 257, 258, 259, 293, 340, 346, 360, 367, 368, 369, 378, 379, 399, 400, 411, 390, 345, 540, 429, 430, 475, 341, 401, 402, 452, 352, 467, 541, 543, 544, 476, 405, 427, 539, 555, 561, 578, 581, 582, 583, 590, 431, 593, 612, 613, 619, 620, 621, 628, 631, 646 });//123 floor
        ...
        BottomTiles.Add(new List<int> { });//6
        BottomTiles.Add(new List<int> { });//6
        BottomTiles.Add(new List<int> { 622, 623, 624, 625, 626, 627, 628, 629, 630, 631, 632, 633, 634, 635, 636, 637, 638, 639, 640 });//622
