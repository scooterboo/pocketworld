...
public class TileMenuTiles : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        toptabs.AddRange(new List<int> { -1, 6, 6, 6, 6, 547, 561, 641, 721, 801, -2 }); 
        ...
        BottomTiles.Add(new List<int> { 13, 42, 43, 44, 45, 46, 65, 66, 113, 213, 214, 242, 243, 306, 307, 308, 309, 310, 329, 330, 347, 506, 507, 518, 527, 535 });//13 water
        BottomTiles.Add(new List<int> { 16, 17, 18, 56, 57, 58, 59, 63, 64, 76, 77, 84, 296, 297, 298, 299, 301, 303, 304, 327, 328, 508, 528, 509, 529, 511, 512, 513, 514, 515, 516, 517, 536, 510, 537, 6, 6, 6, 6, 6, 6, 6, 530, 538, 531 });//18 cliffs
        ...
        BottomTiles.Add(new List<int> { 14, 22, 41, 244, 217, 218, 487, 488 });//14 man made obsticles
        ...
        BottomTiles.Add(new List<int> { 295, 343, 532, 542 });//343 rocks
        ...
        BottomTiles.Add(new List<int> { 124, 125, 143, 144, 146, 147, 188, 204, 205, 208, 209, 351, 437, 403, 404, 412, 413, 414, 415, 416, 417 });//125 bookcases
        ...
        BottomTiles.Add(new List<int> { 117, 123, 132, 148, 158, 159, 160, 161, 162, 163, 164, 165, 166, 168, 173, 176, 179, 207, 257, 258, 259, 293, 340, 346, 360, 367, 368, 369, 378, 379, 399, 400, 411, 390, 345, 540, 429, 430, 475, 341, 401, 402, 452, 352, 467, 541, 543, 544, 476, 405, 427, 539, 6, 6, 6, 6, 6, 6, 6, 431 });//123 floor
        BottomTiles.Add(new List<int> { 128, 129, 172, 191, 285, 388, 517, 533, 534 });//128 stairs
        BottomTiles.Add(new List<int> { 322, 342, 441, 443, 313, 500, 6, 6, 6, 6, 323, 344, 442, 6, 6, 501 });//342 statues
        ...
        BottomTiles.Add(new List<int> { });//6
        BottomTiles.Add(new List<int> { });//6
        BottomTiles.Add(new List<int> { 547, 548, 549, 550, 551, 552, 553, 554, 555, 556, 557, 558, 559, 560 });//547
