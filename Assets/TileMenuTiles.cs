...
public class TileMenuTiles : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        toptabs.AddRange(new List<int> { -1, 222, 255, 445, 456, 274, 6, 6, 6, 6, -2 });
        //and then do the rest of the tiles 80 at a time:
        toptabs.AddRange(new List<int> { -1, 6, 6, 6, 6, 6, 6, 687, 721, 801, -2 }); 
        ...
        BottomTiles.Add(new List<int> { 14, 22, 41, 244, 217, 218, 487, 488, 614 });//14 man made obsticles
        ...
        BottomTiles.Add(new List<int>());//-1
        BottomTiles.Add(new List<int> { 139, 140, 189, 190, 170, 171, 407, 408, 545, 546 });//139 indoor plants
        BottomTiles.Add(new List<int> { 118, 119, 120, 121, 133, 134, 564, 136, 138, 141, 142, 149, 150, 155, 157, 197, 198, 199, 200, 211, 382, 383, 385, 387, 386, 364, 365, 557, 558, 559, 560, 169, 626, 627, 629, 647, 648, 649, 650, 654, 670, 671 });//119 tables
        BottomTiles.Add(new List<int> { 127, 130, 135, 137, 152, 182, 183, 184, 185, 421, 245, 246, 423, 422, 391, 392, 393, 394, 380, 381, 410, 586, 587, 588, 589, 592, 624, 625, 630 });//135 TV Typewriters http://catb.org/~esr/jargon/html/tv-typewriters.html
        BottomTiles.Add(new List<int> { 124, 125, 143, 144, 146, 147, 188, 204, 205, 208, 209, 351, 437, 403, 404, 412, 413, 414, 415, 416, 417, 568, 632, 633, 634, 635, 640, 644, 660 });//125 bookcases
        BottomTiles.Add(new List<int> { 122, 126, 131, 181, 145, 151, 153, 154, 156, 167, 174, 194, 195, 196, 202, 203, 453, 468, 272, 280, 284, 287, 348, 355, 349, 350, 357, 339, 384, 409, 389, 406, 440, 553, 566, 569, 585, 622, 623, 636, 637, 645, 651, 652, 655, 657, 658, 659, 663, 664, 661, 662, 665, 666, 667, 668, 675, 678, 673, 674, 677, 680, 681 });//122 walls
        BottomTiles.Add(new List<int> { 117, 123, 132, 148, 158, 159, 160, 161, 162, 163, 164, 165, 166, 168, 173, 176, 179, 207, 257, 258, 259, 293, 340, 346, 360, 367, 368, 369, 378, 379, 399, 400, 411, 390, 345, 540, 429, 430, 475, 341, 401, 402, 452, 352, 467, 541, 543, 544, 476, 405, 427, 539, 555, 561, 578, 581, 582, 583, 590, 431, 593, 612, 613, 619, 620, 621, 628, 631, 646, 669, 672, 676, 679, 682, 683, 684, 685, 686 });//123 floor
        BottomTiles.Add(new List<int> { 128, 129, 172, 191, 285, 388, 517, 533, 534, 556, 579, 611, 617 });//128 stairs
        BottomTiles.Add(new List<int> { 322, 342, 441, 443, 313, 500, 565, 567, 591, 6, 323, 344, 442, 6, 6, 501 });//342 statues
        BottomTiles.Add(new List<int> { 186, 187, 192, 175, 177, 178, 180, 193, 210, 281, 282, 283, 286, 288, 289, 290, 291, 292, 353, 354, 356, 358, 359, 370, 371, 372, 373, 374, 375, 376, 377, 562, 563, 571, 572, 549, 584, 241, 432, 439, 433, 438, 465, 420, 435, 436, 434, 419, 418, 398, 395, 396, 424, 425, 426, 428, 397, 547, 548, 550, 551, 552, 554, 201, 206, 570, 580, 638, 639, 641, 642, 643, 653, 656 });//193 partitions
        BottomTiles.Add(new List<int>());//-2
        BottomTiles.Add(new List<int>());//-1
        ...
        BottomTiles.Add(new List<int> { 260, 261, 263, 264, 267, 268, 271, 6, 6, 6, 197, 262, 265, 266, 269, 270, 273, 6, 6, 6, 274, 199, 199, 277, 6, 6, 6, 6, 6, 6, 275, 276, 278, 279 });//274 misc objects
        ...
        BottomTiles.Add(new List<int> { });//6
        BottomTiles.Add(new List<int> { });//6
        BottomTiles.Add(new List<int> { 687, 688, 689, 690, 691, 692, 693, 694, 695, 696, 697, 698, 699, 700, 701, 702, 703, 704, 705, 706, 707, 708, 709, 710, 711, 712, 713, 714, 715, 716, 717, 718, 719, 720 });//687
