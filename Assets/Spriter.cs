...
public class Spriter
{
    ...
    byte[] makemenu()
    {
        ...
        menu.Add(GBImage8x8Rip(0x12010));
        menu.Add(GBImage8x8Rip(0x12020));
        menu.Add(GBImage8x8Rip(0x12030));
        menu.Add(GBImage8x8Rip(0x12040));
        menu.Add(GBImage8x8Rip(0x12070));
        menu.Add(GBImage8x8Rip(0x12040));
        menu.Add(GBImage8x8Rip(0x12050));
        menu.Add(GBImage8x8Rip(0x12020));
        menu.Add(GBImage8x8Rip(0x12060));
        int counter = 0;
