...
public class the_world : MonoBehaviour
{
    ...
    public void Start()
    {
        ...
        //houses
        {
            int[] temparr = { 1, 2, 3, 4, 7, 8, 9, 11, 12, 23, 24, 26, 27, 28, 29, 30, 31, 33, 34,
            35, 36, 37, 38, 47, 48, 49, 50, 69, 71, 72, 73, 74, 75, 78, 79, 80, 81, 82, 83, 101, 102, 103 , 104, 105, 106, 109, 110, 111, 112 };
